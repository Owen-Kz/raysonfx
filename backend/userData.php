...
if(isset($userId)){
	...
	if($count == 1){
        ...
        $user = array("username" => $username, "user_fullname" => $fullname, "account_balance" => $accountBalance, "totalInterest" => $INTEREST, "user_email" => $email, "Intitials" => getInitials($fullname));
